		...
		if( audio.paused == false || nOsc == 1 || nMicro_on == 1 )
		{
			if( nFreqIsAPI == 1 )
			{
				...
				if( nMusicVisu == 0 && anaSwitch['freq'] == 1 && ( document.getElementById('nLineEq').style.visibility == 'visible' || nDisplaySource == 'freq' ) )
				{
					...
					nFreqProz[0]  = nFreqDataArray[2]    / 255 * 100;
					nFreqProz[1]  = nFreqDataArray[4]    / 255 * 100;
					nFreqProz[2]  = nFreqDataArray[6]    / 255 * 100;
					nFreqProz[3]  = nFreqDataArray[8]    / 255 * 100;
					nFreqProz[4]  = nFreqDataArray[10]   / 255 * 100;
					nFreqProz[5]  = nFreqDataArray[20]   / 255 * 100;
					nFreqProz[6]  = nFreqDataArray[40]   / 255 * 100;
					nFreqProz[7]  = nFreqDataArray[60]   / 255 * 100;
					nFreqProz[8]  = nFreqDataArray[80]   / 255 * 100;
					nFreqProz[9]  = nFreqDataArray[100]  / 255 * 100;
					nFreqProz[10] = nFreqDataArray[120]  / 255 * 100;
					nFreqProz[11] = nFreqDataArray[140]  / 255 * 100;
					nFreqProz[12] = nFreqDataArray[160]  / 255 * 100;
					nFreqProz[13] = nFreqDataArray[180]  / 255 * 100;
					nFreqProz[14] = nFreqDataArray[200]  / 255 * 100;
					nFreqProz[15] = nFreqDataArray[240]  / 255 * 100;
					nFreqProz[16] = nFreqDataArray[320]  / 255 * 100;
					nFreqProz[17] = nFreqDataArray[400]  / 255 * 100;
					nFreqProz[18] = nFreqDataArray[480]  / 255 * 100;
					nFreqProz[19] = nFreqDataArray[560]  / 255 * 100;
					nFreqProz[20] = nFreqDataArray[640]  / 255 * 100;
					nFreqProz[21] = nFreqDataArray[720]  / 255 * 100;
					nFreqProz[22] = nFreqDataArray[780]  / 255 * 100;
					nFreqProz[23] = nFreqDataArray[840]  / 255 * 100;
				}
